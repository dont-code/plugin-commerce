...
describe('WebEcologieScrapper', () => {
  ...
  it('should search', (done) => {
    ...
    expectOneSampleFile("webecologie/chardon-marie-search.html", httpTestingController,AbstractOnlineShopScrapper.CORS_PROXY_ORG_URL);
  });
  ...
  it('should get price', (done) => {
    ...
    expectOneSampleFile("webecologie/chardon-marie-product.html", httpTestingController,AbstractOnlineShopScrapper.CORS_PROXY_ORG_URL);
  });
